			...
			<div id="myTabContent" class="tab-content">
				<div class="text-left">
					<ol class="breadcrumb">
						...
						<li><a
							href="${base}/user/index.htm?blog_userid=${myuser.getUser_id()}">博主博客</a></li>
					...
					<div class="text-right">
						<div class="btn-group" role="group">
							<button type="button" class="btn btn-default">
								<a
									href="${pageContext.request.contextPath}/user/index.htm?blog_userid=${blog.getUser_id()}">目录视图</a>
							</button>
							<c:if test="${not empty myuser.getUser_id()}">
								...
								<button type="button" class="btn btn-default">
									<a
										href="${pageContext.request.contextPath}/blog/editBlogPage.htm?blog_id=${blog.getBlog_id()}">编辑博文</a>
								</button>
							</c:if>
						</div>
					</div>
